...
INSERT INTO `ns_cms_pages` VALUES (1,NULL,1,0,30,1,'ns_cms_pages_root_page','ns_cms_pages_root_page',NULL,0,1),(2,1,2,1,3,1,'Главная','main','NSCmsBundle:Pages:page_index.html.twig',0,1),(3,1,4,1,5,1,'О компании','about',NULL,1,1),(4,1,6,1,19,1,'Услуги','service',NULL,2,1),(5,1,20,1,21,1,'Программные продукты','software',NULL,3,1),(6,1,22,1,23,1,'Управление проектами','project-management',NULL,4,1),(7,1,24,1,25,1,'Наши партнеры','partnerships',NULL,5,1),(8,1,26,1,27,1,'Контакты','contacts',NULL,6,1),(9,4,7,2,8,1,'Бухгалтерский и налоговый учет',NULL,NULL,0,1),(10,4,9,2,10,1,'Бюджетное управление',NULL,NULL,1,1),(11,4,11,2,12,1,'Решения для строительной отрасли',NULL,NULL,2,1),(12,4,13,2,14,1,'Консолидация',NULL,NULL,3,1),(13,4,15,2,16,1,'Управленческий учет',NULL,NULL,4,1),(14,4,17,2,18,1,'Зарплата и управление персоналом',NULL,NULL,5,1),(15,1,28,1,29,1,'Результаты поиска','search',NULL,7,0);
...
-- Dump completed on 2014-03-24 22:28:03
